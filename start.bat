...
set CP="%DIRNAME%openpos.jar"

set CP=%CP%;"%DIRNAME%lib/jasperreports-3.7.2.jar"
...
set CP=%CP%;"%DIRNAME%lib/commons-beanutils-1.8.0.jar"
set CP=%CP%;"%DIRNAME%lib/commons-digester-1.7.jar"
set CP=%CP%;"%DIRNAME%lib/iText-2.1.7.jar"
set CP=%CP%;"%DIRNAME%lib/poi-3.5-FINAL-20090928.jar"
...
start /B javaw -cp %CP% -Djava.library.path="%DIRNAME%lib/Windows/i368-mingw32" -Duser.home=config com.openbravo.pos.forms.StartPOS %1
