...
public class CustomersView extends javax.swing.JPanel implements EditorRecord {
    ...
    private void initComponents() {
        ...
        add(jButton2);
        jButton2.setBounds(470, 104, 49, 25);
        ...
        add(jButton3);
        jButton3.setBounds(525, 104, 49, 25);
        ...
        add(jTabbedPane1);
        jTabbedPane1.setBounds(10, 295, 533, 235);
        ...
        jLabel34.setText(bundle.getString("label.DebtDateLimit")); // NOI18N
        add(jLabel34);
        jLabel34.setBounds(10, 259, 180, 25);

        jcboDebtDateLimit.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "COD", "7 Dite", "15 Dite", "30 Dite" }));
        add(jcboDebtDateLimit);
        jcboDebtDateLimit.setBounds(194, 259, 130, 25);

        jLabel35.setText(bundle.getString("label.mode")); // NOI18N
        add(jLabel35);
        jLabel35.setBounds(344, 259, 70, 25);

        jcboDebtMode.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Data Fatures", "Cdo te Hene" }));
        add(jcboDebtMode);
