...
public class JTicketsBagRestaurantRes extends javax.swing.JPanel implements EditorRecord {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(10, 150, 80, 25);

        jLabel3.setText(AppLocal.getIntString("rest.label.chairs")); // NOI18N
        jPanel1.add(jLabel3);
        jLabel3.setBounds(10, 180, 80, 25);

        jLabel4.setText(AppLocal.getIntString("rest.label.notes")); // NOI18N
        jPanel1.add(jLabel4);
        jLabel4.setBounds(10, 210, 80, 25);
        jPanel1.add(m_jtxtDescription);
        m_jtxtDescription.setBounds(90, 210, 220, 100);
        jPanel1.add(m_jtxtChairs);
        m_jtxtChairs.setBounds(90, 180, 140, 25);
        jPanel1.add(txtCustomer);
        txtCustomer.setBounds(90, 150, 220, 25);
        ...
        jButton1.setBounds(310, 150, 48, 25);
