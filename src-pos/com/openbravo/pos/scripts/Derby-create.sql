...
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('1', 'Menaxheri', $FILE{/com/openbravo/pos/templates/Role.Manager.xml} );
...
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('0', 'Administratori', NULL, '0', 1, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('1', 'Menaxheri', NULL, '1', 1, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('2', 'Nepunes', NULL, '2', 1, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('3', 'Test', NULL, '3', 1, NULL);
...
CREATE TABLE CUSTOMERS (
    ...
    DEBTDATELIMIT VARCHAR(256) NULL,
    DEBTMODE VARCHAR(1024) NULL,
    PRIMARY KEY (ID),
...
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('001', 'TVSH', '001', NULL, NULL, 0.20, 0, NULL);
...
CREATE TABLE TICKETSNUM_SUPPLIERT (ID INTEGER GENERATED ALWAYS AS IDENTITY (START WITH 1));
...
INSERT INTO FLOORS(ID, NAME, IMAGE) VALUES ('0', 'Restorant', $FILE{/com/openbravo/pos/templates/restaurantsample.png});
...
INSERT INTO BREAKS(ID, NAME, VISIBLE, NOTES) VALUES ('0', 'Dreke', 1, NULL);
INSERT INTO BREAKS(ID, NAME, VISIBLE, NOTES) VALUES ('1', 'Pasdite', 1, NULL);
INSERT INTO BREAKS(ID, NAME, VISIBLE, NOTES) VALUES ('2', 'Gjysem Turni', 1, NULL);
