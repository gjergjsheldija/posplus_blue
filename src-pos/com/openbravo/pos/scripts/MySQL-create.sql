...
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('0', 'Administratori', $FILE{/com/openbravo/pos/templates/Role.Administrator.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('1', 'Manager', $FILE{/com/openbravo/pos/templates/Role.Manager.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('2', 'Nepunes', $FILE{/com/openbravo/pos/templates/Role.Employee.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('3', 'Test', $FILE{/com/openbravo/pos/templates/Role.Guest.xml} );
...
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('0', 'Administratori', NULL, '0', TRUE, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('1', 'Manager', NULL, '1', TRUE, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('2', 'Nepunes', NULL, '2', TRUE, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('3', 'Test', NULL, '3', TRUE, NULL);
...
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('18', 'banknote.5000lek', 1, $FILE{/com/openbravo/pos/templates/5000Lek.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('19', 'banknote.2000lek', 1, $FILE{/com/openbravo/pos/templates/2000Lek.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('20', 'banknote.1000lek', 1, $FILE{/com/openbravo/pos/templates/1000Lek.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('21', 'banknote.500lek', 1, $FILE{/com/openbravo/pos/templates/500Lek.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('22', 'banknote.200lek', 1, $FILE{/com/openbravo/pos/templates/200Lek.jpg});

INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('23', 'coin.100lek', 1, $FILE{/com/openbravo/pos/templates/100Lek.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('24', 'coin.50lek', 1, $FILE{/com/openbravo/pos/templates/50Lek.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('25', 'coin.20lek', 1, $FILE{/com/openbravo/pos/templates/20Lek.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('26', 'coin.10lek', 1, $FILE{/com/openbravo/pos/templates/10Lek.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('27', 'coin.5lek', 1, $FILE{/com/openbravo/pos/templates/5Lek.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('28', 'coin.1lek', 1, $FILE{/com/openbravo/pos/templates/1Lek.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('29', 'Printer.PartialCash', 0, $FILE{/com/openbravo/pos/templates/Printer.PartialCash.xml});

INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('31', 'Printer.CustomerPaid', 0, $FILE{/com/openbravo/pos/templates/Printer.SupplierPaid.xml});
...
INSERT INTO CATEGORIES(ID, NAME) VALUES ('000', 'Kategori Standart');
INSERT INTO CATEGORIES(ID, NAME) VALUES ('0', 'Perberje');
...
INSERT INTO TAXCATEGORIES(ID, NAME) VALUES ('000', 'Pa Takse');
INSERT INTO TAXCATEGORIES(ID, NAME) VALUES ('001', 'TVSH');
...
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('000', 'Pa Takse', '000', NULL, NULL, 0, 0, NULL);
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('001', 'TVSH', '001', NULL, NULL, 0.10, 0, NULL);
...
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('1', 'Tavolina 01', 133, 151, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('2', 'Tavolina 02', 266, 151, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('3', 'Tavolina 03', 399, 151, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('4', 'Tavolina 04', 532, 151, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('5', 'Tavolina 05', 133, 264, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('6', 'Tavolina 06', 266, 264, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('7', 'Tavolina 07', 399, 264, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('8', 'Tavolina 08', 532, 264, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('9', 'Tavolina 09', 133, 377, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('10', 'Tavolina 10', 266, 377, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('11', 'Tavolina 11', 399, 377, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('12', 'Tavolina 12', 532, 377, '0');
...
INSERT INTO BREAKS(ID, NAME, VISIBLE, NOTES) VALUES ('0', 'Dreke', TRUE, NULL);
INSERT INTO BREAKS(ID, NAME, VISIBLE, NOTES) VALUES ('1', 'Pasdite', TRUE, NULL);
INSERT INTO BREAKS(ID, NAME, VISIBLE, NOTES) VALUES ('2', 'Gjysem Turni', TRUE, NULL);
...
CREATE ALGORITHM = UNDEFINED VIEW  `CUST_STATEMENT` AS SELECT CUSTOMERS.ID AS CUSTOMERID, TICKETS.ID, RECEIPTS.DATENEW, TICKETS.TICKETID, PAYMENTS.PAYMENT, 0 AS debit, PAYMENTS.TOTAL AS credit, CUSTOMERS.NAME
FROM RECEIPTS, TICKETS, CUSTOMERS, PAYMENTS WHERE RECEIPTS.ID = TICKETS.ID AND RECEIPTS.ID = PAYMENTS.RECEIPT AND TICKETS.CUSTOMER = CUSTOMERS.ID
AND ( PAYMENTS.PAYMENT =  'debt' OR PAYMENTS.PAYMENT =  'cash' ) AND TICKETTYPE =0
UNION SELECT CUSTOMER, p.TICKETID, DATENEW,  t.TICKETID, PAYMENT, TOTAL, 0,  ''
FROM  `RECEIPTS` r, PAYMENTS p, TICKETS t
WHERE p.RECEIPT = r.ID AND (PAYMENT <>  'debt' AND PAYMENT <>  'debtpaid' ) AND r.ID = t.ID AND p.TICKETID IN ( SELECT ID FROM TICKETS WHERE TICKETTYPE =0 AND STATUS =9 );
